...
activities = {
    ...
    "Swimming Club": {
        ...
        "max_participants": 18,
        "participants": ["laura@mergington.edu", "nick@mergington.edu"]
    },
    "Art Club": {
    ...
    "Drama Club": {
        ...
        "max_participants": 25,
        "participants": ["amanda@mergington.edu", "kyle@mergington.edu"]
    },
    "Math Olympiad": {
    ...
    "Robotics Club": {
        ...
        "max_participants": 18,
        "participants": ["aaron@mergington.edu", "maya@mergington.edu"]
    }
}
